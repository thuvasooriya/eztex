/* bibtex.c -- WEB2C BibTeX adapted for tectonic bridge I/O.
 * Originally from SwiftLaTeX/TeX Live, adapted to use ttstub_* bridge
 * functions instead of kpse_find_file + direct fopen/fclose.
 */
#include "bibtex.h"
...
/* kpse format -> TTBC file format mapping */
#define kpse_tex_format TTBC_FILE_FORMAT_TEX
#define kpse_bib_format TTBC_FILE_FORMAT_BIB
#define kpse_bst_format TTBC_FILE_FORMAT_BST
...
/* Peekable input wrapper using ttstub_* bridge I/O.
 * Handles ungetc/EOF semantics for BibTeX's Pascal-style I/O. */
